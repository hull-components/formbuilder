  ...
  Formbuilder = (function() {
    Formbuilder.helpers = {
      defaultFieldAttrs: function(field_type) {
        ...
        attrs[Formbuilder.options.mappings.NAME] = 'field_name';
...
(function() {
  Formbuilder.registerField('date', {
    order: 20,
    view: "<%= rf.get(Formbuilder.options.mappings.FORMAT) %>",
    edit: "<div class='fb-edit-section-header'>Date Format</div>\n<input type=\"text\" data-rv-input=\"model.<%= Formbuilder.options.mappings.FORMAT %>\" placeholder=\"yyyy-mm-dd\" />",
...
'\' placeholder=\'Add a placeholder to this field\' />\n<textarea data-rv-input=\'model.' +
...
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<span style=\'float:right\'><i>' +
((__t = ( Formbuilder.helpers.simple_format(rf.get(Formbuilder.options.mappings.NAME)) )) == null ? '' : __t) +
'</i></span>\n<label>\n  <span>' +
